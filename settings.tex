...
\lstdefinelanguage{Rust}{
  keywords={break, const, continue, else, enum, extern, fn, for, if, impl, in, let, loop, match, mod, pub, return, struct, trait, type, unsafe, use, where, while},
  keywordstyle=\color{blue}\bfseries,
  ndkeywords={bool, i8, i16, i32, i64, isize, u8, u16, u32, u64, usize, f32, f64, String, str, char, Option, Some, None, Box, Vec, Result, Ok, Err},
