...
\hyphenation {ap-pros-si-ma-zio-ne}
...
\paragraph{Stima dell'errore inerente del metodo di Horner/Ruffini.}
...
\end{itemize}
Nel seguito vogliamo esaminare se è possibile agire sull'espressione $p(x)$ al
fine di ridurre l'errore inerente. Si introduce il concetto di
\textbf{condizionamento di una base polinomiale} per indicare quale
