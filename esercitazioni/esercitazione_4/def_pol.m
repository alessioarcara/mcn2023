...
%function che definisce polinomi in [0,1] sia nella
%base canonica che di Bersntein

switch ex
    case 1
        % polinomio di Wilkinson di grado 6;
        % cP coefficienti nella base dei monomi (1,t,t^2,...,t^6):
    ...
    case 2
        % polinomio di grado 10 con coefficienti di segno alterno nella base monomiale;
        % cP coefficienti nella base dei monomi (1,t,t^2,...,t^10):
    ...
    case 3
        ...
        % base di Bernstein che monomiale;
        % cP coefficienti nella base dei monomi (1,t,t^2,...,t^10):
        % cB coefficienti nella base di Bernstein
        g = 10;
    ...
    case 4
        % p(t)=1+t+t^2+...+t^g
        % CP coefficienti nella base monomiale:
        % 1, ..., 1
        % CB coefficienti nella base di Bernstein:
        % 1, (g+1)/g, ... , (g+1)/2, g+1
        g = 6;
